...
public class ShopPageForCustomers extends BaseFrame {
    ...
    public ShopPageForCustomers(Customer c,Order o) 
    {
        ...
        lstProductsByCategoryTyped = new javax.swing.JList<>();
        jScrollPane2.setViewportView(lstProductsByCategoryTyped);
    ...
    */
    ...
    private void lstCategoriesValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_lstCategoriesValueChanged
        ...
        DefaultListModel<Product> categoryModel = new DefaultListModel<>();// create a new DefaultListModel to hold products of that category --fix imports
        ...
        lstProductsByCategoryTyped.setModel(categoryModel);// updates the second list (lstProductsByCategoryTyped)
